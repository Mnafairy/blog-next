const Page = () => {
  return (
    <div className="w-[643px] m-auto">
      ...
      <div className="w-[643px] h-[460px] m-auto pt-[29px] pr-[130xp] pb-[26px] pl-[35px] flex flex-col gap-6 bg-[#F6F6F7] rounded-xl">
        <div className=" font-semib text-xl">Leave a Message</div>
        <div className="flex flex-col gap-5 text-lg">
          <div className="flex w-[478px] justify-between">
            <input
              className="w-[225px] py-[14px] px-5 rounded-md"
              type="text"
          ...
          <div>
            <input
              className=" py-[14px] px-5 w-[478px] h-[130px] rounded-md placeholder:-translate-y-8"
              type="text"
